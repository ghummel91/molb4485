...
raxmlHPC-PTHREADS-AVX -T 8 -f a -m GTRGAMMA -p 618 -N 50  -x 309 -s AllBears.aln -n AllBears -w /project/inbre-train/inbre011/molb4485/hummel_Phylo/BearTrees/Alignment2  -o GiantPanda
